...
$pdf->Cell(176, 5, 'Realtor Recieved payments ', 0, 0, 'C');
  $pdf->Ln();
  $pdf->Ln();
  $pdf->Ln(); 
...
$pdf->Cell(0,12,'PropertyTitle : '. $row['PropertyTitle'],0,1);
$pdf->Cell(0,12,'buyerid : '. $row['buyerid'],0,1);
$pdf->Cell(0,12,'recieved amounts : '. $row['ad'],0,1);
$pdf->Cell(0,12,'Recieved Date : '. $row['Date'],0,1);
// $image1 = "img/*.jpg";
