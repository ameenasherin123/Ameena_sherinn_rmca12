              ...
              ?>      
                  ...
                  <?php } ?>
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" name="statename" id="statename" required="true" placeholder="State Name" class="form-control" required onchange="validateadd();">
