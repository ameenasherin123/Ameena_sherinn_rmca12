...
?>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-14">
                            <div class="card">
                                  <?php $query5=mysqli_query($con,"Select * from tbl_users where status='2'");
...
?>
           ...
           <div class="row">
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                <?php $query4=mysqli_query($con,"Select * from tbl_users where status='1'");
...
?>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                 <?php $query6=mysqli_query($con,"Select * from tbl_users where status='3'");
