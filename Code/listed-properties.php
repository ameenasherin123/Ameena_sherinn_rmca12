...
<head>
    ...
    <title>Realtor || Listed Properties</title>
    <!-- Bootstrap CSS -->
...
<body>
   ...
   <th>Mobile no</th>
            ...
            <th data-breakpoints="xs">Action</th>
                                        ...
                                        <tbody>
                                          <?php
$ret=mysqli_query($con,"select tbl_users.full_name,tbl_users.mob_no,tblproperty.PropertyTitle,tblproperty.ID from tblproperty join tbl_users on tbl_users.ID=tblproperty.UserID");
$cnt=1;
