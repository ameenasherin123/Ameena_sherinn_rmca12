...
$query=mysqli_query($con,"select password from tbl_users where status='4' and password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update tbl_users set password='$newpassword' where status='4'");
...
<head>
    ...
    <title>Realtor || Change Password</title>
    <!-- Bootstrap CSS -->
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <span id="msg1" style="color:red;"></span>
                                                 <input type="password" name="newpassword" id="newpassword" class="form-control" value="" required='true' required onchange="validateadd();">
...
function validatep(){
    ...
    {
        document.getElementById('msg1').innerHTML="Password should contain atleast 6 characters";
