...
<head>
    ...
    <title>Realtor || Add Country</title>
    <!-- Bootstrap CSS -->
    ...
    echo $msg;
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" name="countryname" id="countryname" required="true" placeholder="Country Name" class="form-control" required onchange="validateadd();">
