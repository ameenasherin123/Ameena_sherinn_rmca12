...
<head>
    ...
    <title>Realtor || Update State</title>
    <!-- Bootstrap CSS -->
              ...
              ?>      
                  ...
                  <?php } ?>
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" name="statename" id="statename" required="true" value="<?php echo $row['sname'];?>" class="form-control" required onchange="validateadd();">

                                                <script>
function validateadd(){
    var val = document.getElementById('statename').value;
