...
<head>
    ...
    <title>Realtor || Add Property Type</title>
    <!-- Bootstrap CSS -->
    ...
    echo $msg;
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" name="propertytype" id="propertytype" required="true" placeholder="Property Type" class="form-control" required onchange="validateadd();">
