                                ...
                                <div id="submenu-5" class="collapse submenu" style="">
                                    ...
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                         ...
                                         <li class="nav-item">
                                            <a class="nav-link" href="paymentdetails.php">Recieved Payments</a></li>
                                         <li class="nav-item">

                                            <a class="nav-link" href="search-property.php"><i class="fas fa-fw fa-file"></i> Search Properties</a>
                                        </li>
