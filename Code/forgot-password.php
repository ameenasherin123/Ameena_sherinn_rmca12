...
if(isset($_POST['submit']))
  {
    ...
    $email=$_POST['email'];
        ...
        $query=mysqli_query($con,"select ID from tbl_users where email_id='$email' and mob_no='$contactno'");
...
<head>
    ...
    <title>Realtor || Fogot Password</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="splash-container">
        <div class="card">
            <div class="card-header text-center"><h2 style="color: blue">REALTORS</h2><span class="splash-description">Please enter your login information.</span></div>
            <div class="card-body">
