...
<head>
    ...
    <title>Realtor || Update Country</title>
    <!-- Bootstrap CSS -->
...
?>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                ...
                                                <input type="text" name="countryname" id="countryname" required="true" class="form-control" value="<?php  echo $row['CountryName'];?>" required onchange="validateadd();">
